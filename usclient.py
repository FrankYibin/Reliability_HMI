...
class upcClient(QObject):
    def __init__(self):
        QObject.__init__(self)
        self.url = "127.0.0.1"
        self.port = 5001
        endpoint = "opc.tcp://{}:{}".format(self.url, self.port)
        # Assign endpoint url on the OPC UA client  address space
        myclient = Client(endpoint)
        # Connect to server
        myclient.connect()
        self.M_Start = myclient.get_node('ns=3;s="OPCUA"."1#M_Start"')
        self.M_Reset = myclient.get_node('ns=3;s="OPCUA"."1#M_Reset"')
        self.M_Mode = myclient.get_node('ns=3;s="OPCUA"."1#M_Mode"')
        self.M_DataReady = myclient.get_node('ns=3;s="OPCUA"."1#M_DataReady"')
        self.M_AlarmLock = myclient.get_node('ns=3;s="OPCUA"."1#M_AlarmLock"')
        self.E_STOP = myclient.get_node('ns=3;s="OPCUA"."1#E_STOP"')
        self.M_BatchSize = myclient.get_node('ns=3;s="OPCUA"."1#M_BatchSize"')
        self.M_CycleCounter = myclient.get_node('ns=3;s="OPCUA"."1#M_CycleCounter"')
        self.M_AlarmNumber = myclient.get_node('ns=3;s="OPCUA"."1#M_AlarmNumber"')
        self.M_Ready = myclient.get_node('ns=3;s="OPCUA"."1#M_Ready"')
        self.M_Alarm = myclient.get_node('ns=3;s="OPCUA"."1#M_Alarm"')
        self.M_Sonics = myclient.get_node('ns=3;s="OPCUA"."1#M_Sonics"')
        self.M_PPM = myclient.get_node('ns=3;s="OPCUA"."1#M_PPM"')
        self.M_CurrentTune = myclient.get_node('ns=3;s="OPCUA"."1#M_CurrentTune"')
        self.M_CurrentFre_offset = myclient.get_node('ns=3;s="OPCUA"."1#M_CurrentFre_offset"')
        self.M_CurrentAmplitude = myclient.get_node('ns=3;s="OPCUA"."1#M_CurrentAmplitude"')
        self.M_CurrentPower = myclient.get_node('ns=3;s="OPCUA"."1#M_CurrentPower"')
        self.M_PowerArray = myclient.get_node('ns=3;s="OPCUA"."1#M_PowerArray"')
        self.M_PowerLength = myclient.get_node('ns=3;s="OPCUA"."1#M_PowerLength"')
        self.M_Start2 = myclient.get_node('ns=3;s="OPCUA"."2#M_Start"')
        self.M_Reset2 = myclient.get_node('ns=3;s="OPCUA"."2#M_Reset"')
        self.M_Mode2 = myclient.get_node('ns=3;s="OPCUA"."2#M_Mode"')
        self.M_DataReady2 = myclient.get_node('ns=3;s="OPCUA"."2#M_DataReady"')
        self.M_AlarmLock2 = myclient.get_node('ns=3;s="OPCUA"."2#M_AlarmLock"')
        self.E_STOP2 = myclient.get_node('ns=3;s="OPCUA"."2#E_STOP"')
        self.M_BatchSize2 = myclient.get_node('ns=3;s="OPCUA"."2#M_BatchSize"')
        self.M_CycleCounter2 = myclient.get_node('ns=3;s="OPCUA"."2#M_CycleCounter"')
        self.M_AlarmNumber2 = myclient.get_node('ns=3;s="OPCUA"."2#M_AlarmNumber"')
        self.M_Ready2 = myclient.get_node('ns=3;s="OPCUA"."2#M_Ready"')
        self.M_Alarm2 = myclient.get_node('ns=3;s="OPCUA"."2#M_Alarm"')
        self.M_Sonics2 = myclient.get_node('ns=3;s="OPCUA"."2#M_Sonics"')
        self.M_PPM2 = myclient.get_node('ns=3;s="OPCUA"."2#M_PPM"')
        self.M_CurrentTune2 = myclient.get_node('ns=3;s="OPCUA"."2#M_CurrentTune"')
        self.M_CurrentFre_offset2 = myclient.get_node('ns=3;s="OPCUA"."2#M_CurrentFre_offset"')
        self.M_CurrentAmplitude2 = myclient.get_node('ns=3;s="OPCUA"."2#M_CurrentAmplitude"')
        self.M_CurrentPower2 = myclient.get_node('ns=3;s="OPCUA"."2#M_CurrentPower"')
        self.M_PowerArray2 = myclient.get_node('ns=3;s="OPCUA"."2#M_PowerArray"')
        self.M_PowerLength2 = myclient.get_node('ns=3;s="OPCUA"."2#M_PowerLength"')
        self.M_Start3 = myclient.get_node('ns=3;s="OPCUA"."3#M_Start"')
        self.M_Reset3 = myclient.get_node('ns=3;s="OPCUA"."3#M_Reset"')
        self.M_Mode3 = myclient.get_node('ns=3;s="OPCUA"."3#M_Mode"')
        self.M_DataReady3 = myclient.get_node('ns=3;s="OPCUA"."3#M_DataReady"')
        self.M_AlarmLock3 = myclient.get_node('ns=3;s="OPCUA"."3#M_AlarmLock"')
        self.E_STOP3 = myclient.get_node('ns=3;s="OPCUA"."3#E_STOP"')
        self.M_BatchSize3 = myclient.get_node('ns=3;s="OPCUA"."3#M_BatchSize"')
        self.M_CycleCounter3 = myclient.get_node('ns=3;s="OPCUA"."3#M_CycleCounter"')
        self.M_AlarmNumber3 = myclient.get_node('ns=3;s="OPCUA"."3#M_AlarmNumber"')
        self.M_Ready3 = myclient.get_node('ns=3;s="OPCUA"."3#M_Ready"')
        self.M_Alarm3 = myclient.get_node('ns=3;s="OPCUA"."3#M_Alarm"')
        self.M_Sonics3 = myclient.get_node('ns=3;s="OPCUA"."3#M_Sonics"')
        self.M_PPM3 = myclient.get_node('ns=3;s="OPCUA"."3#M_PPM"')
        self.M_CurrentTune3 = myclient.get_node('ns=3;s="OPCUA"."3#M_CurrentTune"')
        self.M_CurrentFre_offset3 = myclient.get_node('ns=3;s="OPCUA"."3#M_CurrentFre_offset"')
        self.M_CurrentAmplitude3 = myclient.get_node('ns=3;s="OPCUA"."3#M_CurrentAmplitude"')
        self.M_CurrentPower3 = myclient.get_node('ns=3;s="OPCUA"."3#M_CurrentPower"')
        self.M_PowerArray3 = myclient.get_node('ns=3;s="OPCUA"."3#M_PowerArray"')
        self.M_PowerLength3 = myclient.get_node('ns=3;s="OPCUA"."3#M_PowerLength"')
        self.M_Start4 = myclient.get_node('ns=3;s="OPCUA"."4#M_Start"')
        self.M_Reset4 = myclient.get_node('ns=3;s="OPCUA"."4#M_Reset"')
        self.M_Mode4 = myclient.get_node('ns=3;s="OPCUA"."4#M_Mode"')
        self.M_DataReady4 = myclient.get_node('ns=3;s="OPCUA"."4#M_DataReady"')
        self.M_AlarmLock4 = myclient.get_node('ns=3;s="OPCUA"."4#M_AlarmLock"')
        self.E_STOP4 = myclient.get_node('ns=3;s="OPCUA"."4#E_STOP"')
        self.M_BatchSize4 = myclient.get_node('ns=3;s="OPCUA"."4#M_BatchSize"')
        self.M_CycleCounter4 = myclient.get_node('ns=3;s="OPCUA"."4#M_CycleCounter"')
        self.M_AlarmNumber4 = myclient.get_node('ns=3;s="OPCUA"."4#M_AlarmNumber"')
        self.M_Ready4 = myclient.get_node('ns=3;s="OPCUA"."4#M_Ready"')
        self.M_Alarm4 = myclient.get_node('ns=3;s="OPCUA"."4#M_Alarm"')
        self.M_Sonics4 = myclient.get_node('ns=3;s="OPCUA"."4#M_Sonics"')
        self.M_PPM4 = myclient.get_node('ns=3;s="OPCUA"."4#M_PPM"')
        self.M_CurrentTune4 = myclient.get_node('ns=3;s="OPCUA"."4#M_CurrentTune"')
        self.M_CurrentFre_offset4 = myclient.get_node('ns=3;s="OPCUA"."4#M_CurrentFre_offset"')
        self.M_CurrentAmplitude4 = myclient.get_node('ns=3;s="OPCUA"."4#M_CurrentAmplitude"')
        self.M_CurrentPower4 = myclient.get_node('ns=3;s="OPCUA"."4#M_CurrentPower"')
        self.M_PowerArray4 = myclient.get_node('ns=3;s="OPCUA"."4#M_PowerArray"')
        self.M_PowerLength4 = myclient.get_node('ns=3;s="OPCUA"."4#M_PowerLength"')

        # # create subscription by passing period in milliseconds and handler
        subscribe = myclient.create_subscription(0, self)
        # subscribe.subscribe_data_change(self.M_Start)
        # subscribe.subscribe_data_change(self.M_Reset)
        # subscribe.subscribe_data_change(self.M_Mode)
        # subscribe.subscribe_data_change(self.M_DataReady)
        # subscribe.subscribe_data_change(self.M_AlarmLock)
        # subscribe.subscribe_data_change(self.E_STOP)
        # subscribe.subscribe_data_change(self.M_BatchSize)
        # subscribe.subscribe_data_change(self.M_CycleCounter)
        # subscribe.subscribe_data_change(self.M_AlarmNumber)
        # subscribe.subscribe_data_change(self.M_Ready)
        # subscribe.subscribe_data_change(self.M_Alarm)
        # subscribe.subscribe_data_change(self.M_Sonics)
        # subscribe.subscribe_data_change(self.M_PPM)
        # subscribe.subscribe_data_change(self.M_CurrentTune)
        # subscribe.subscribe_data_change(self.M_CurrentFre_offset)
        # subscribe.subscribe_data_change(self.M_CurrentAmplitude)
        # subscribe.subscribe_data_change(self.M_CurrentPower)
        # subscribe.subscribe_data_change(self.M_PowerArray)
        # subscribe.subscribe_data_change(self.M_PowerLength)
        # subscribe.subscribe_data_change(self.M_Start2)
        # subscribe.subscribe_data_change(self.M_Reset2)
        # subscribe.subscribe_data_change(self.M_Mode2)
        # subscribe.subscribe_data_change(self.M_DataReady2)
        # subscribe.subscribe_data_change(self.M_AlarmLock2)
        # subscribe.subscribe_data_change(self.E_STOP2)
        # subscribe.subscribe_data_change(self.M_BatchSize2)
        # subscribe.subscribe_data_change(self.M_CycleCounter2)
        # subscribe.subscribe_data_change(self.M_AlarmNumber2)
        # subscribe.subscribe_data_change(self.M_Ready2)
        # subscribe.subscribe_data_change(self.M_Alarm2)
        # subscribe.subscribe_data_change(self.M_Sonics2)
        # subscribe.subscribe_data_change(self.M_PPM2)
        # subscribe.subscribe_data_change(self.M_CurrentTune2)
        # subscribe.subscribe_data_change(self.M_CurrentFre_offset2)
        # subscribe.subscribe_data_change(self.M_CurrentAmplitude2)
        # subscribe.subscribe_data_change(self.M_CurrentPower2)
        # subscribe.subscribe_data_change(self.M_PowerArray2)
        # subscribe.subscribe_data_change(self.M_PowerLength2)
        # subscribe.subscribe_data_change(self.M_Start3)
        # subscribe.subscribe_data_change(self.M_Reset3)
        # subscribe.subscribe_data_change(self.M_Mode3)
        # subscribe.subscribe_data_change(self.M_DataReady3)
        # subscribe.subscribe_data_change(self.M_AlarmLock3)
        # subscribe.subscribe_data_change(self.E_STOP3)
        # subscribe.subscribe_data_change(self.M_BatchSize3)
        # subscribe.subscribe_data_change(self.M_CycleCounter3)
        # subscribe.subscribe_data_change(self.M_AlarmNumber3)
        # subscribe.subscribe_data_change(self.M_Ready3)
        # subscribe.subscribe_data_change(self.M_Alarm3)
        # subscribe.subscribe_data_change(self.M_Sonics3)
        # subscribe.subscribe_data_change(self.M_PPM3)
        # subscribe.subscribe_data_change(self.M_CurrentTune3)
        # subscribe.subscribe_data_change(self.M_CurrentFre_offset3)
        # subscribe.subscribe_data_change(self.M_CurrentAmplitude3)
        # subscribe.subscribe_data_change(self.M_CurrentPower3)
        # subscribe.subscribe_data_change(self.M_PowerArray3)
        # subscribe.subscribe_data_change(self.M_PowerLength3)
        # subscribe.subscribe_data_change(self.M_Start4)
        # subscribe.subscribe_data_change(self.M_Reset4)
        # subscribe.subscribe_data_change(self.M_Mode4)
        # subscribe.subscribe_data_change(self.M_DataReady4)
        # subscribe.subscribe_data_change(self.M_AlarmLock4)
        # subscribe.subscribe_data_change(self.E_STOP4)
        # subscribe.subscribe_data_change(self.M_BatchSize4)
        # subscribe.subscribe_data_change(self.M_CycleCounter4)
        # subscribe.subscribe_data_change(self.M_AlarmNumber4)
        # subscribe.subscribe_data_change(self.M_Ready4)
        # subscribe.subscribe_data_change(self.M_Alarm4)
        # subscribe.subscribe_data_change(self.M_Sonics4)
        # subscribe.subscribe_data_change(self.M_PPM4)
        # subscribe.subscribe_data_change(self.M_CurrentTune4)
        # subscribe.subscribe_data_change(self.M_CurrentFre_offset4)
        # subscribe.subscribe_data_change(self.M_CurrentAmplitude4)
        # subscribe.subscribe_data_change(self.M_CurrentPower4)
        # subscribe.subscribe_data_change(self.M_PowerArray4)
        # subscribe.subscribe_data_change(self.M_PowerLength4)
